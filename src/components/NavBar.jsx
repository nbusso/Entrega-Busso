...
export function NavBar() {
  ...
  return (
    <Navbar
      fullWidth={true}
      className="align-text-bottom mx-auto max-w-screen-2xl bg-vaporwave-gustoGold border-none shadow-md px-6 py-3"
    >
      <div className="flex items-center justify-between text-blue-gray-900">
        ...
        <IconButton
          variant="text"
          className="ml-auto mr-4 h-6 w-6 text-inherit hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
          ripple={false}
